...
def calculate_estimate_data(payload):
    ...
    # Quality-Based Price Scaling Logic
    ...
    return {
        ...
        "project_type": project_info.get('projectType', 'N/A'), "quality_level": q_level, "zip_code": project_info.get('zipCode', 'N/A'),
        "items": processed_items, "mat_sub_min": f"{mat_sub[0]:,.2f}", "mat_sub_avg": f"{mat_sub[1]:,.2f}", "mat_sub_max": f"{mat_sub[2]:,.2f}",
